...
import GdsTaskForceGdsCheckYourAnswers from './index';
...
const meta: Meta<typeof GdsTaskForceGdsCheckYourAnswers> = {
  title: 'GdsTaskForceGdsCheckYourAnswers',
  component: GdsTaskForceGdsCheckYourAnswers,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof GdsTaskForceGdsCheckYourAnswers>;
...
export const BaseGdsTaskForceGdsCheckYourAnswers: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <>
      <GdsTaskForceGdsCheckYourAnswers {...props} {...args}>{regionAChildren}</GdsTaskForceGdsCheckYourAnswers>
    </>
  );
};

BaseGdsTaskForceGdsCheckYourAnswers.args = {
  readOnly: false,
  showLabel: true,
  label: 'Form template',
  NumCols: 1,
