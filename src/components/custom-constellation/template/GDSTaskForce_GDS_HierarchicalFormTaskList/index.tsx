...
export const GdsTaskForceGdsHierarchicalFormTaskList = (props: HierarchicalFormAsTasksProps) => {
  ...
  return (
    <>
      ...
      <FieldGroup name={heading}>
        ...
        {/* Task Detail View */}
        {views.map(
          view => view.visible && <TaskDetail key={view.id} task={view} onSubmit={submitView} onClose={closeView} getPConnect={getPConnect} />
        )}
      </FieldGroup>
    </>
  );
...
export default withConfiguration(GdsTaskForceGdsHierarchicalFormTaskList);
