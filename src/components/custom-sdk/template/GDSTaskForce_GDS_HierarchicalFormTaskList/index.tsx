...
import StyledGdsTaskForceGdsHierarchicalFormTaskListWrapper from './styles';

interface GdsTaskForceGdsHierarchicalFormTaskListProps extends PConnProps {
...
export default function GdsTaskForceGdsHierarchicalFormTaskList(props: PropsWithChildren<GdsTaskForceGdsHierarchicalFormTaskListProps>) {
  ...
  return (
    <StyledGdsTaskForceGdsHierarchicalFormTaskListWrapper>
      <>
        {instructions && (
