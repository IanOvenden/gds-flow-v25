...
const meta: Meta<typeof GdsTaskForceGdsHierarchicalFormTaskList> = {
  title: 'GdsTaskForceGdsHierarchicalFormTaskList',
...
export const BaseGdsTaskForceGdsHierarchicalFormTaskList: Story = args => {
  ...
  return <GdsTaskForceGdsHierarchicalFormTaskList {...props} {...args} />;
};

BaseGdsTaskForceGdsHierarchicalFormTaskList.args = {};
